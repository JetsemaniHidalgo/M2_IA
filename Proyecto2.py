...
for variable in variables_numericas:
    ...
    sns.histplot(data=casas, x=variable, kde=True)
...
for variable in variables_numericas:
    plt.figure(figsize=(10, 6))
    sns.scatterplot(x=variable, y='Valor_casa', data=casas, alpha=0.5)
    plt.title(f'Gráfico de dispersión entre {variable} y Valor_casa')
    plt.grid(True)
    plt.show()
...
nuevo_caso1 = [[17000, 3, 1]]  # Primer caso con departamento codificado como 1
nuevo_caso2 = [[15400, 1, 0]]  # Segundo caso con departamento codificado como 0
